	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <span class="navbar-toggler-icon"></span>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">	
					<li class="nav-item"><a class="nav-link" href="DatHang.jsp">Xác nhận đặt hàng</a></li>
					<li class="nav-item"><a class="nav-link" href="DatHang.jsp">Hàng đã mua</a></li>
				</ul>
		...
		<div class="modal-dialog modal-style">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="mx-auto">
						<form class="container border py-4 border-info" action="tc.jsp" method="get">
							<%
							String tb = null;
							String tendn = "";
							String mk = "";
